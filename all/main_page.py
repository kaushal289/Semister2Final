...
class MainPage:
    def __init__(self):
        ...
        self.img1 = ImageTk.PhotoImage(Image.open("ace.png"))  # make sure that you have a photo
        # in you current folder that you are working with
        self.img2 = ImageTk.PhotoImage(Image.open("ace1.png"))
        self.img3 = ImageTk.PhotoImage(Image.open("ace2.png"))
        self.img4 = ImageTk.PhotoImage(Image.open("ace3.png"))
        # Create a label
    ...
    def inside_menu_sub_frame(self,num):
        ...
        if num==0:
            self.my_canvas1.create_text(150,30,text='ROOM',font=("Rockwell nova", 20))
        elif num==1:
            self.my_canvas1.create_text(150, 30, text='FOOD',font=("Rockwell nova", 20))
        else:
            self.my_canvas1.create_text(150, 30, text='PICK UP',font=("Rockwell nova", 20))
    def fn_details(self):
