...
class CustomBurger:
    ...
    def burger_tomato(self):
        if self.btn_tomato.cget('text')=='Tomato:No':
            ...
            self.to = self.c + 1
            if self.pi == 1 and self.ce == 1 and self.ch == 1:
                self.num_to = 4
            elif self.pi == 1 and self.ce == 1 or self.pi == 1 and self.ch == 1 or self.ce == 1 and self.ch == 1:
                self.num_to = 3
            elif self.pi == 1 or self.ch == 1 or self.ce == 1:
                self.num_to = 2
            elif self.to==1:
                self.num_to = 1
            print(self.num_to)
    ...
    def burger_pickel(self):
        if self.btn_pickle.cget('text') == 'Pickle:No':
            ...
            self.pi=self.c+1
            if self.to == 1 and self.ce == 1 and self.ch == 1:
                self.num_pi = 4
            elif self.to == 1 and self.ce == 1 or self.to == 1 and self.ch == 1 or self.ce == 1 and self.ch == 1:
                self.num_pi = 3
            elif self.to == 1 or self.ch == 1 or self.ce == 1:
                self.num_pi = 2
            elif self.pi==1:
                self.num_pi = 1
            print(self.num_pi)
            ...
            if self.pi==-1:
                try:
                    if self.num_ch > self.num_pi:
                        ...
                        self.login5 = ImageTk.PhotoImage(Image.open(f'chicken_img/6.png'))
                        self.my_canvas.create_image(self.b, self.a, image=self.login5, anchor="nw")
                    if self.num_ce > self.num_pi:
                        self.num_ce = self.num_ce - 1
                        self.a = self.a + 40
                        self.login4 = ImageTk.PhotoImage(Image.open(f'cheese_img/6.png'))
                        self.my_canvas.create_image(self.b, self.a, image=self.login4, anchor="nw")
                    if self.num_to > self.num_pi:
                        self.num_to = self.num_to - 1
                        self.a = self.a + 40
                        self.login2 = ImageTk.PhotoImage(Image.open(f'tomato_img/6.png'))
                        self.my_canvas.create_image(self.b, self.a, image=self.login2, anchor="nw")
                except:
                    pass
            self.a = self.pos_pi + 40
            self.login3 = ImageTk.PhotoImage(Image.open(f'remove.png'))
            self.my_canvas.create_image(self.b, self.a, image=self.login3, anchor="nw")
            self.btn_pickle.config(text="Pickle:No", bg="black")
    def burger_chees(self):
        if self.btn_chees.cget('text') == 'Cheese:No':
            ...
            self.ce = self.c + 1
            if self.pi == 1 and self.to == 1 and self.ch == 1:
                self.num_ce = 4
            elif self.pi == 1 and self.to == 1 or self.pi == 1 and self.ch == 1 or self.to == 1 and self.ch == 1:
                self.num_ce = 3
            elif self.pi == 1 or self.ch == 1 or self.to == 1:
                self.num_ce = 2
            elif self.ce == 1:
                self.num_ce = 1
            print(self.num_ce)
            ...
            if self.ce==-1:
                try:
                    if self.num_ch > self.num_ce:
                        self.num_ch = self.num_ch - 1
                        self.a = self.a + 40
                        self.login5 = ImageTk.PhotoImage(Image.open(f'chicken_img/6.png'))
                        self.my_canvas.create_image(self.b, self.a, image=self.login5, anchor="nw")
                    if self.num_pi > self.num_ce:
                        self.num_pi = self.num_pi - 1
                        self.a = self.a + 40
                        self.login3 = ImageTk.PhotoImage(Image.open(f'pickle_img/6.png'))
                        self.my_canvas.create_image(self.b, self.a, image=self.login3, anchor="nw")

                    if self.num_to > self.num_ce:
                        self.num_to = self.num_to - 1
                        self.a = self.a + 40
                        self.login2 = ImageTk.PhotoImage(Image.open(f'tomato_img/6.png'))
                        self.my_canvas.create_image(self.b, self.a, image=self.login2, anchor="nw")
    ...
    def burger_chicken(self):
        if self.btn_chicken.cget('text') == 'Chicken:No':
            ...
            self.ch = self.c + 1
            if self.pi == 1 and self.to == 1 and self.ce == 1:
                self.num_ch = 4
            elif self.pi == 1 and self.to == 1 or self.pi == 1 and self.ce == 1 or self.to == 1 and self.ce == 1:
                self.num_ch = 3
            elif self.pi == 1 or self.ce == 1 or self.to == 1:
                self.num_ch = 2
            elif self.ch == 1:
                self.num_ch = 1
            print(self.num_ch)
            ...
            if self.ch==-1:
                try:
                    ...
                    if self.num_pi > self.num_ch:
                        self.num_pi = self.num_pi - 1
                        self.a = self.a + 40
                        self.login3 = ImageTk.PhotoImage(Image.open(f'pickle_img/6.png'))
                        self.my_canvas.create_image(self.b, self.a, image=self.login3, anchor="nw")

                    if self.num_to > self.num_ch:
                        self.num_to = self.num_to - 1
                        self.a = self.a + 40
                        self.login2 = ImageTk.PhotoImage(Image.open(f'tomato_img/6.png'))
                        self.my_canvas.create_image(self.b, self.a, image=self.login2, anchor="nw")
